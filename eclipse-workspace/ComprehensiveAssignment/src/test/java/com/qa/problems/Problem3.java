...
//			wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.xpath("//iframe[starts-with(@title, 'webengage')]")));			
...
//			driver.findElement(By.xpath("//li[@data-cy='roundTrip']/span")).click();
			...
			searchButton.click();
			// Sleep for a while to load the page
			...
			if(searchPage.isDisplayed()) {
				System.out.println("Searched Page is Displayed Successfully");
			};
